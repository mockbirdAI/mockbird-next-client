            ...
            <TabsContent value="overview" className="space-y-4">
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold">{userData.candidateInterviews.length}</div>
                    <p className="text-xs text-muted-foreground">
                      +0.0% from last month
                    </p>
                  </CardContent>
              ...
              <div className="grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-7">
                <Card className="col-span-4">
                  <CardHeader>
                    <CardTitle>Recruiters For You</CardTitle>
                  </CardHeader>
                ...
                <Card className="col-span-4 md:col-span-3">
                  <CardHeader>
                    ...
                    <CardDescription>
                      You have {userData.candidateInterviews.length} interview{userData.candidateInterviews.length == 1 ? "" : "s"} upcoming.
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-8">
                      {userData.candidateInterviews.length === 0 ? (
            ...
            <TabsContent value="requests" className="space-y-4">
              <Card className="col-span-4 md:col-span-3">
                <CardHeader>
                  ...
                  <CardDescription>
                    You have {userData.candidateRequests.length} interview request{userData.candidateRequests.length == 1 ? "" : "s"} pending.
                  </CardDescription>  
                </CardHeader>
                <CardContent>
                  <div className="space-y-8">
                    {userData.candidateRequests.length === 0 ? (
