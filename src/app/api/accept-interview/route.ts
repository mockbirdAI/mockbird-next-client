...
export async function POST(request: any) {
  ...
  const options = {
    ...
    body: `{"title":"string","preferred_region":"us-east-1","record_on_start":true,"live_stream_on_start":false,"recording_config":{"max_seconds":60,"file_name_prefix":"string","video_config":{"codec":"H264","width":1280,"height":720,"watermark":{"url":"https://mockbird.ai","size":{"width":1,"height":1},"position":"left top"},"export_file":true},"audio_config":{"codec":"AAC","channel":"stereo","export_file":true},"storage_config":{"type":"azure","access_key":${process.env.AZURE_STORAGE_ACCOUNT_ACCESS_KEY},"secret":"","bucket":"mockbirdmeetings","region":"","path":"","auth_method":"KEY","username":"string","password":"string","host":"string","port":0,"private_key":"string"},"dyte_bucket_config":{"enabled":true},"live_streaming_config":{"rtmp_url":"rtmp://a.rtmp.youtube.com/live2"}}}`
  };
